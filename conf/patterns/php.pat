...
list "keywords" = "as,case,if,else,elseif,while,do,for,foreach,break,continue,switch,declare,return,require,include,require_once,include_once,var,class,new,function,default,null,false,true"
