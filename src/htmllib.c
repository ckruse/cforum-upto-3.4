...
/* {{{ Initial comments */
/*
 * $LastChangedDate: 2009-02-10 14:27:31 +0100 (Tue, 10 Feb 2009) $
 * $LastChangedRevision: 1695 $
      ...
      case '<':
        if(cf_strncmp(ptr,"<br />",6) == 0) {
          ...
          if(cf_strncmp(ptr,"<br />-- <br />",15) == 0 && stack->elements == 0) {
            ...
            if(xml) str_chars_append(content,"<br /><span class=\"sig\">-- ",27);
            else str_chars_append(content,"<br><span class=\"sig\">-- ",25);
            ptr += 9;
            sig = 1;
          }
