...
void flt_pavatar_get_cache_filename(const u_char *uri,u_char **cachefile,u_char **cacheuri) {
  ...
  str_init_growth(&str1,256);
  str_cstr_set(&str,flt_pavatar_cachedir);
  str_cstr_set(&str1,flt_pavatar_cacheuri);
  str_char_append(&str,'/');
  str_char_append(&str1,'/');
...
/* {{{ flt_pavatar_exec */
int flt_pavatar_exec(cf_hash_t *head,configuration_t *dc,configuration_t *vc,cl_thread_t *thread,message_t *msg,cf_tpl_variable_t *hash) {
  u_char *uri;
  name_value_t *cs;

  if(!flt_pavatar_active) return FLT_DECLINE;

  cs = cfg_get_first_value(dc,flt_pavatar_fn,"ExternCharset");
...
/* {{{ flt_pavatar_conf */
int flt_pavatar_conf(configfile_t *cfile,conf_opt_t *opt,const u_char *context,u_char **args,size_t argnum) {
  u_char *ptr;
...
conf_opt_t flt_pavatar_config[] = {
  { "PavatarCacheThemAtLeast", flt_pavatar_conf, CFG_OPT_CONFIG|CFG_OPT_LOCAL, NULL },
  { "PavatarCacheThem",        flt_pavatar_conf, CFG_OPT_CONFIG|CFG_OPT_LOCAL, NULL },
  { "PavatarCacheDir",         flt_pavatar_conf, CFG_OPT_CONFIG|CFG_OPT_LOCAL, NULL },
  { "PavatarCacheURI",         flt_pavatar_conf, CFG_OPT_CONFIG|CFG_OPT_LOCAL, NULL },
  { "PavatarCacheTime",        flt_pavatar_conf, CFG_OPT_CONFIG|CFG_OPT_LOCAL, NULL },
  { "PavatarExpiresOverrides", flt_pavatar_conf, CFG_OPT_CONFIG|CFG_OPT_LOCAL, NULL },
  { "PavatarEnableFaviconWay", flt_pavatar_conf, CFG_OPT_CONFIG|CFG_OPT_LOCAL, NULL },
  { "PavatarActive",           flt_pavatar_conf, CFG_OPT_CONFIG|CFG_OPT_USER|CFG_OPT_LOCAL, NULL },
  { NULL, NULL, 0, NULL }
};

handler_config_t flt_pavatar_handlers[] = {
  { PERPOST_VAR_HANDLER, flt_pavatar_exec },
  { 0, NULL }
};

module_config_t flt_pavatar = {
  MODULE_MAGIC_COOKIE,
  flt_pavatar_config,
